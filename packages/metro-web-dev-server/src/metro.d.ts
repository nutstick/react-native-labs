declare module "metro/src/shared/output/bundle" {
  import { OutputOptions, Server } from "metro";
...
declare module "metro" {
  ...
  type AllowOptionalDependencies =
    | boolean
